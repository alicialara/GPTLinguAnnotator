...
from semantic_analysis.config.config import BLACK_CATEGORIES, BLACKEN_CATEGORIES, WHITE_CATEGORIES, WHITEN_CATEGORIES, OUTPUTS_DIR, get_word_model_output_dir
